...
public class EventRegisterer {
    ...
    private static ConcurrentHashMap<Object, ArrayList<IEventListener>> getListeners(EventBus bus) {
        return ReflectionHelper.getPrivateValue(EventBus.class, bus, 1);
    }
            ...
            for (Class<?> cls : supers) {
                try {
                    ...
                    if (real.isAnnotationPresent(SubscribeEvent.class)) {
                        ...
                        ConcurrentHashMap<Object, ArrayList<IEventListener>> listeners = getListeners(bus);
